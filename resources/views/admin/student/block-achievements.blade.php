...
<!--             @if ($achievements[0]->student->registered_date)
            <tr><td>{{ \Carbon\Carbon::parse($achievements[0]->student->registered_date)->format('d-M-y') }}</td><td>Pendaftaran</td><td>...</td><td>...</td></tr>
            @endif -->
